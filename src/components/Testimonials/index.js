...
import profilePicture from "../../assets/images/testimonial-pic.jfif";
  ...
  return (
    <div className="container">
        ...
        <Card data-aos="zoom-in" className="myCard">
          <div className="flexRow align-center">
            ...
            <div className="mlr-10">
              <p className="primaryColor font-16">Tushar Kanti Mishra</p>
      ...
      <Card className="m-auto contactCard">
        ...
        <p className="text-center font-25">tshrmshr5857@gamil.com</p>
      </Card>
    </div>
  );
};
